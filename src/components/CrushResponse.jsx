        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input
              ...
              required
            />
            <small style={{ color: 'black' }} >Note:Enter who YOU like to see if it's the same person who likes you.We don't reveal your crush name to anyone,So,Enter your crush name without any fear!</small>
          </div>
