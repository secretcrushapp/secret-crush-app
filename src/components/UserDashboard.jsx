    ...
    <div className="dashboard-container">
      ...
      <div className="beginner-tip">
        ...
        <ul>
          ...
          <li><strong>Step 3:</strong> (optional) Copy the secret link and share it with them ,Only if you want to, because we will share this to your crush ourselves! (without revealing your name)</li>
                ...
                {request.secretLink && (
                  <div className="secret-link-section">
                    ...
                    <div className="url-display-helper">
                      💡 Tip: optional:Tap on the link above to select it, then share with your crush,Only if you want to because We will share it to your crush ourselves!
                    </div>
                  </div>
                )}
              </div>
